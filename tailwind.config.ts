  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        indisense: {
          purple: "hsl(var(--indisense-purple))",
          cyan: "hsl(var(--indisense-cyan))",
          pink: "hsl(var(--indisense-pink))",
          teal: "hsl(var(--indisense-teal))",
          dark: "hsl(var(--indisense-dark))",
          card: "hsl(var(--indisense-card))",
        },
        emotion: {
